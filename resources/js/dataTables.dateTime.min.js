    ...
    d.extend(q.prototype, {
        ...
        val: function(a, b) {
            ...
            if (a instanceof Date) this.s.d = this._dateToUtc(a);
                ...
                } else g ? (c = g.utc(a, this.c.format, this.c.locale, this.c.strict), this.s.d = c.isValid() ? c.toDate() : null) : (c = a.match(/(\d{4})\-(\d{2})\-(\d{2})/),
                    ...
                    if (e.stopPropagation(), "a" === h && (e.preventDefault(), d(r).hasClass(b + "-clear") ? (a.s.d = null, a.dom.input.val(""), a._writeOutput(), a._setCalander(), a._setTime(), k()) : d(r).hasClass(b + "-today") && (a.s.display = new Date, a._setTitle(), a._setCalander())), "button" ===
                        ...
                        if (e.hasClass("disabled") && !e.hasClass("range")) p.blur();
                            ...
                            if (p.parents("." + b + "-time").length) {
                                ...
                                h.setUTCMonth(p.data("month")), h.setUTCDate(p.data("day")), a._writeOutput(!0), a.s.parts.time ? a._setCalander() : setTimeout(function() {
                                    a._hide()
                                }, 10);
                            k()
                        }
        ...
        _show: function() {
            ...
            setTimeout(function() {
                d("body").on("click." + b, function(k) {
                    d(k.target).parents().filter(a.dom.container).length || k.target === a.dom.input[0] || a._hide()
                })
            }, 10)
        },
