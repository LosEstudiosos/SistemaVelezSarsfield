/*! jQuery DataTables Checkboxes v1.2.12 - www.gyrocode.com/projects/jquery-datatables-checkboxes/ - License: MIT - Author: Gyrocode LLC / www.gyrocode.com */ ! function(c) {
    "function" == typeof define && define.amd ? define(["jquery", "datatables.net"], function(e) {
        ...
        return e = e || window, t && t.fn.dataTable || (t = require("datatables.net")(e, t)
            .$), c(t, 0, e.document)
    ...
    function x(e) {
        ...
        this.s = {
                ...
                , dataDisabled: []
                , ignoreSelect: !1
            }, this.s.ctx = this.s.dt.settings()[0], this.s.ctx.checkboxes || (e.checkboxes = this)
            ._constructor()
    }
    ...
    x.prototype = {
        _constructor: function() {
            for (var e, t, c, s, o, l, a, n = this, d = n.s.dt, i = n.s.ctx, h = !1, u = !1, r = 0; r < i.aoColumns.length; r++) {
                i.aoColumns[r].checkboxes && (e = k(d.column(r)
                    .header()), h = !0, k.isPlainObject(i.aoColumns[r].checkboxes) || (i.aoColumns[r].checkboxes = {}), i.aoColumns[r].checkboxes = k.extend({}, x.defaults, i.aoColumns[r].checkboxes), t = {
                    searchable: !1
                    , orderable: !1
                ...
                }), f.ext.internal._fnColumnOptions(i, r, t), e.removeClass("sorting"), e.off(".dt"), null === i.sAjaxSource && ((c = d.cells("tr", r))
                    .invalidate("data"), k(c.nodes())
                    .addClass(t.className)), n.s.data[r] = {}, n.s.dataDisabled[r] = {}, n.s.columns.push(r), i.aoColumns[r].checkboxes.selectRow && (i._select ? u = !0 : i.aoColumns[r].checkboxes.selectRow = !1), i.aoColumns[r].checkboxes.selectAll && (e.data("html", e.html()), null !== i.aoColumns[r].checkboxes.selectAllRender && (s = "", k.isFunction(i.aoColumns[r].checkboxes.selectAllRender) ? s = i.aoColumns[r].checkboxes.selectAllRender() : "string" == typeof i.aoColumns[r].checkboxes.selectAllRender && (s = i.aoColumns[r].checkboxes.selectAllRender), e.html(s)
                    .addClass("dt-checkboxes-select-all")
                    .attr("data-col", r))))
            }
            h && (n.loadState(), o = k(d.table()
                    .node()), l = k(d.table()
                    .body()), a = k(d.table()
                    .container()), u && (o.addClass("dt-checkboxes-select"), o.on("user-select.dt.dtCheckboxes", function(e, t, c, s, o) {
                ...
                .on("click.dtCheckboxes", '.fixedHeader-floating thead th.dt-checkboxes-select-all input[type="checkbox"]', function(e) {
                    i._fixedHeader && i._fixedHeader.dom.header.floating && n.onClickSelectAll(e, this)
                }), k(b)
                .on("click.dtCheckboxes", ".fixedHeader-floating thead th.dt-checkboxes-select-all", function() {
                    i._fixedHeader && i._fixedHeader.dom.header.floating && k('input[type="checkbox"]', this)
                        .trigger("click")
        ...
        , onDataTablesInit: function() {
            var o = this
                , e = o.s.dt
                , t = o.s.ctx;
            t.oFeatures.bServerSide || (t.oFeatures.bStateSave && o.updateState(), k(e.table()
                    .node())
                .on("xhr.dt.dtCheckboxes", function(e, t, c, s) {
        ...
        , onDataTablesDestroy: function() {
            var e = this.s.dt
                ...
                , s = k(e.table()
                    .container());
            k(b)
                .off("click.dtCheckboxes"), s.off(".dtCheckboxes"), c.off(".dtCheckboxes"), t.off(".dtCheckboxes"), this.s.data = {}, this.s.dataDisabled = {}, k(".dt-checkboxes-select-all", t)
                .each(function(e, t) {
                    k(t)
                        .html(k(t)
                            .data("html"))
        ...
        , updateData: function(e, t, c) {
            var s = this.s.dt
                , o = this.s.ctx;
            o.aoColumns[t].checkboxes && (e.data()
                .each(function(e) {
        ...
        , updateSelect: function(e, t) {
            var c = this.s.dt;
            this.s.ctx._select && (this.s.ignoreSelect = !0, t ? c.rows(e)
                .select() : c.rows(e)
                .deselect(), this.s.ignoreSelect = !1)
        }
        , updateCheckbox: function(e, t, c) {
            var s = this.s.ctx
                , o = e.nodes();
            o.length && (k("input.dt-checkboxes", o)
                .not(":disabled")
                .prop("checked", c), k.isFunction(s.aoColumns[t].checkboxes.selectCallback) && s.aoColumns[t].checkboxes.selectCallback(o, c))
        }
        ...
        , updateStateCheckboxes: function(e) {
            var o = this
                , t = o.s.dt
                , l = o.s.ctx;
            t.cells("tr", o.s.columns, e)
                .every(function(e, t) {
                    var c = this.data()
                        , s = o.isCellSelectable(t, c);
                    l.checkboxes.s.data[t].hasOwnProperty(c) && (o.updateCheckbox(this, t, !0), l.aoColumns[t].checkboxes.selectRow && s && o.updateSelect(e, !0)), s || k("input.dt-checkboxes", this.node())
                        .prop("disabled", !0)
                })
        }
        , onClick: function(e, c) {
            var s = this
                ...
                , l = k(c)
                .closest("td")
                , a = l.parents(".DTFC_Cloned")
                .length ? t.fixedColumns()
                .cellIndex(l) : l
                , n = t.cell(a)
                , d = n.index()
                .column;
        ...
        , onClickSelectAll: function(e, t) {
            var c = this.s.dt
                ...
                , l = k(t)
                .closest("th");
            o = l.parents(".DTFC_Cloned")
                .length ? c.fixedColumns()
                .cellIndex(l)
                .column : c.column(l)
                .index(), k(t)
                .data("is-changed", !0), c.column(o, {
        ...
        , updateSelectAll: function(c) {
            ...
            x.aoColumns[c].checkboxes && x.aoColumns[c].checkboxes.selectAll && (e = b.cells("tr", c, {
                ...
                .container(), s = k('.dt-checkboxes-select-all[data-col="' + c + '"] input[type="checkbox"]', t), l = o = 0, a = e.data(), k.each(a, function(e, t) {
                    ...
                    checked: !d && n
                    , indeterminate: d
                }), k.isFunction(x.aoColumns[c].checkboxes.selectAllCallback) && x.aoColumns[c].checkboxes.selectAllCallback(s.closest("th")
                    .get(0), n, d)))
        }
            ...
            if (e.aanFeatures.i) {
                ...
                if (null !== t) {
                    ...
                    k.each(e.aanFeatures.i, function(e, t) {
                        ...
                        c = "row", s = d, l.append(k('<span class="select-item"/>')
                            .append(n.i18n("select." + c + "s", {
                                _: "%d " + c + "s selected"
                                , 0: ""
                                , 1: "1 " + c + " selected"
                            }, s)));
        ...
        , getCellIndex: function(e) {
            var t = this.s.dt;
            return this.s.ctx._oFixedColumns ? t.fixedColumns()
                .cellIndex(e) : t.cell(e)
                .index()
        }
        ...
        , updateFixedColumn: function(e) {
            var t, c, s = this
                , o = s.s.dt
                , l = s.s.ctx;
            l._oFixedColumns && (t = l._oFixedColumns.s.iLeftColumns, c = l.aoColumns.length - l._oFixedColumns.s.iRightColumns - 1, (e < t || c < e) && (o.fixedColumns()
    ...
    return t.register("checkboxes()", function() {
            ...
            return void 0 === i && (i = !0), this.iterator("column-rows", function(c, s, e, t, o) {
                ...
                c.aoColumns[s].checkboxes && (d = [], k.each(o, function(e, t) {
                    ...
                    .data(), n = [], d = [], k.each(a, function(e, t) {
            ...
            return void 0 === a && (a = !0), this.iterator("cell", function(e, t, c) {
                ...
                e.aoColumns[c].checkboxes && (o = (s = this.cell({
                    ...
                    .data(), a ? delete e.checkboxes.s.dataDisabled[c][o] : e.checkboxes.s.dataDisabled[c][o] = 1, (l = s.node()) && k("input.dt-checkboxes", l)
                    .prop("disabled", !a), e.aoColumns[c].checkboxes.selectRow && e.checkboxes.s.data[c].hasOwnProperty(o) && e.checkboxes.updateSelect(t, a))
            }, 1)
            ...
            return this.iterator("column", function(e, t) {
                e.aoColumns[t].checkboxes && (e.checkboxes.s.data[t] = {}, this.column(t)
                    .checkboxes.select(!1))
            }, 1)
            ...
            return this.iterator("column-rows", function(c, s, e, t, o) {
                if (c.aoColumns[s].checkboxes) {
                    ...
                    return c.oFeatures.bServerSide ? k.each(c.checkboxes.s.data[s], function(e) {
                        ...
                        .data(), k.each(a, function(e, t) {
                            c.checkboxes.s.data[s].hasOwnProperty(t) && c.checkboxes.isCellSelectable(s, t) && n.push(t)
                        })), n
                }
                return []
            }, 1)
        }), x.version = "1.2.12", k.fn.DataTable.Checkboxes = x, k.fn.dataTable.Checkboxes = x, k(b)
        .on("preInit.dt.dtCheckboxes", function(e, t) {
