! function(e, t) {
    ...
    var C, k = (C = "undefined" != typeof Uint8Array && c(Uint8Array), function(e) {
        ...
        , U = {
            ...
            , toFlatObject: function(e, t, n, r) {
                ...
                do {
                    for (i = (o = Object.getOwnPropertyNames(e))
                        .length; i-- > 0;) a = o[i], r && !r(a, e, t) || s[a] || (t[a] = e[a], s[a] = !0);
                    e = !1 !== n && c(e)
            ...
            , forEachEntry: function(e, t) {
                for (var n, r = (e && e[Symbol.iterator])
                        .call(e);
                    (n = r.next()) && !n.done;) {
                    var o = n.value;
                    t.call(e, o[0], o[1])
    ...
    function F(e, t, n, r, o) {
        Error.call(this), Error.captureStackTrace ? Error.captureStackTrace(this, this.constructor) : this.stack = (new Error)
            .stack, this.message = e, this.name = "AxiosError", t && (this.code = t), n && (this.config = n), r && (this.request = r), o && (this.response = o)
    }
    U.inherits(F, Error, {
        toJSON: function() {
            return {
    ...
    function G(e, t, n) {
        ...
        var r, o = n && n.encode || X
            , i = n && n.serialize;
        if (r = i ? i(t, n) : U.isURLSearchParams(t) ? t.toString() : new V(t, n)
            .toString(o)) {
    ...
    var pe = function(e, n) {
        ...
        return r(i, [{
                ...
                return U.isPlainObject(e) || e instanceof this.constructor ? f(e, t) : U.isString(e) && (e = e.trim()) && !/^[-_a-zA-Z]+$/.test(e.trim()) ? f((c = {}, (i = e) && i.split("\n")
                    .forEach((function(e) {
                        u = e.indexOf(":"), a = e.substring(0, u)
                            .trim()
                            .toLowerCase(), s = e.substring(u + 1)
                            .trim(), !a || c[a] && ce[a] || ("set-cookie" === a ? c[a] ? c[a].push(s) : c[a] = [s] : c[a] = c[a] ? c[a] + ", " + s : s)
            ...
            , value: function() {
                ...
                return (e = this.constructor)
                    .concat.apply(e, [this].concat(n))
            }
        }, {
            key: "toJSON"
            , value: function(e) {
    ...
    var ge = oe.isStandardBrowserEnv ? {
        write: function(e, t, n, r, o, i) {
            var a = [];
            a.push(e + "=" + encodeURIComponent(t)), U.isNumber(n) && a.push("expires=" + new Date(n)
                .toGMTString()), U.isString(r) && a.push("path=" + r), U.isString(o) && a.push("domain=" + o), !0 === i && a.push("secure"), document.cookie = a.join("; ")
        }
        , read: function(e) {
    ...
    var Re = function(e) {
        for (var t, n, r = (e = U.isArray(e) ? e : [e])
                .length, o = 0; o < r && (t = e[o], !(n = U.isString(t) ? Se[t.toLowerCase()] : t)); o++);
        if (!n) {
    ...
    function je(e) {
        return Ae(e), e.headers = me.from(e.headers), e.data = ve.call(e, e.transformRequest), -1 !== ["post", "put", "patch"].indexOf(e.method) && e.headers.setContentType("application/x-www-form-urlencoded", !1), Re(e.adapter || ue.adapter)(e)
            .then((function(t) {
            ...
            return r(e, [{
                ...
                , value: function(e, t) {
                    ...
                    void 0 !== o && Pe.assertOptions(o, {
                        ...
                        .toLowerCase(), (n = a && U.merge(a.common, a[t.method])) && U.forEach(["delete", "get", "head", "post", "put", "patch", "common"], (function(e) {
                            delete a[e]
                ...
                key: "getUri"
                , value: function(e) {
                    return G(we((e = xe(this.defaults, e))
                        .baseURL, e.url), e.params, e.paramsSerializer)
                }
            }]), e
        }();
